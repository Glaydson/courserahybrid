...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $localStorage) {
  ...
  .controller('IndexController', ['$scope', 'leader', 'dish', 'promotion', 'menuFactory', 'promotionFactory','corporateFactory',
    'baseURL', function($scope, leader, dish, promotion, menuFactory, promotionFactory, corporateFactory, baseURL) {
